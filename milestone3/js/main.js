  ...
  createApp({
    ...
    methods: {
      ...
      conversationArray() {
        ...
        this.conversation = this.contacts[this.currentChat].messages;
      ...
      chooseChat(position){
        ...
        this.contacts[this.currentChat].visible = true;
      ...
      sendMessage() {
        ...
        this.conversation.push(justSent);
        this.newMessage = "";
      ...
      receiveMessage() {
        ...
        this.conversation.push(justReceived);
        console.log(this.conversation);
